  ...
  _createClass(Carousel, [{
    ...
    value: function autoPlay() {
      ...
      this.animTime = setTimeout(function () {
        if (!_this6.sel.animation) {
          _this6.sel.animation = true;
          _this6.sel.acount++;
          _this6.animate();
        }
        _this6.el.dot.removeClass('active');
        _this6.el.dot.eq(_this6.sel.acount === 3 ? 0 : _this6.sel.acount).addClass('active');
        _this6.autoPlay();
      }, 5000);
    }
  }, {
    key: 'mouseoverEvent',
    value: function mouseoverEvent() {
      var _this7 = this;

      this.el.homepageCarousel.on('mouseover', function () {
        console.log('mouseover', _this7.animTime);
        clearTimeout(_this7.animTime);
      });
    }
  }, {
    key: 'mouseoutEvent',
    value: function mouseoutEvent() {
      var _this8 = this;
