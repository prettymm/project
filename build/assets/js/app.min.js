  ...
  _createClass(Filter, [{
    ...
    value: function setItems() {
      ...
      for (var i = 0, len = Obj.datas.length; i < len; i++) {
        html += '<div class="l-grid__col l-w--tabt-min-33p">' + '<div dataTag="' + Obj.datas[i].dataTag + '" class="tagged-elem show">' + '<a href="' + Obj.datas[i].href + '">' + '<div class="icon-place-holder">' + '<img src="' + Obj.datas[i].img + '" />' + '</div>' + '<div class="tagged-elem-title">' + Obj.datas[i].title + '</div>' + '<p>' + Obj.datas[i].text + '</p>' + '</a></div></div>';
      }
