...
var Filter = function (_MLP$apps$MLPModule) {
  _inherits(Filter, _MLP$apps$MLPModule);
  ...
  _createClass(Filter, [{
    ...
    value: function init() {
      ...
      _get(Filter.prototype.__proto__ || Object.getPrototypeOf(Filter.prototype), 'init', this).call(this);
      this.datas();
      this.events();
    }
  }, {
    ...
    value: function setItems() {
      ...
      for (var i = 0, len = Obj.datas.length; i < len; i++) {
        html += '<div class="l-grid__col l-w--tabt-min-33p">' + '<div data-tag="' + Obj.datas[i].dataTag + '" class="tagged-elem show">' + '<a href="' + Obj.datas[i].href + '">' + '<div class="icon-place-holder">' + '<img src="' + Obj.datas[i].img + '" />' + '</div>' + '<div class="tagged-elem-title">' + Obj.datas[i].title + '</div>' + '<p>' + Obj.datas[i].text + '</p>' + '</a></div></div>';
      }
    ...
    key: 'containTag',
    value: function containTag(_id, _array) {
...
var Map = function (_MLP$apps$MLPModule) {
  ...
  _createClass(Map, [{
    ...
    value: function init() {
      ...
      emitter.on('initMap', function () {
        _this3.map = new google.maps.Map(document.getElementById('map'), {
          center: _this3.haightAshbury,
          zoom: 2,
          styles: _this3.styledMap
        });
        _this3.events();
      });
    }
    ...
    key: 'closeInfoWindow',
    value: function closeInfoWindow(inx, map, marker) {
    ...
    key: 'setMapOnAll',
    value: function setMapOnAll(map, key) {
      var _this = this;
      var iconBase = 'assets/img/locations/icon-';
    ...
    key: 'itemClickEvents',
    value: function itemClickEvents() {
      var _this = this;
